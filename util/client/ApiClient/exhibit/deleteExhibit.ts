 ...
 */
export async function deleteExhibit(title: string): Promise<ApiResponse<PopulatedExhibit>> {
 ...
 */
export async function deleteExhibits(...titles: string[]): Promise<ApiResponse<PopulatedExhibit[]>> {
 ...
 * on the server
 */
export async function deleteAllExhibits(): Promise<ApiResponse<PopulatedExhibit[]>> {
